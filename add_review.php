...
<body class="bg-gray-900">
    ...
    <!-- Form -->
    <section class="bg-white h-lvh dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Review</h2>
            <form action="handler.php" method="post" enctype="multipart/form-data">
                <div class="gap-4 sm:gap-6">
                    <div class="w-full mb-4">
                        <label for="fnb" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select
                            FnB</label>
                    ...
                    <div class="w-full mb-4">
                        <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Review
                            Title</label>
                        <input type="text" name="title" id="title"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Type review title" required>
                    </div>
                    <div class="w-full mb-4">
                        <label for="rating"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Rating</label>
                        <input type="text" name="rating" id="rating" min="1" max="5"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="0.5 - 5 ★" required>
                    </div>
                    <div class="w-full mb-4">
                        ...
                        <textarea id="review" name="review" rows="8"
                            ...
                            placeholder="Your full review here" required></textarea>
                    </div>
                    <div class="w-full mb-2">
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                            for="review_photo">Upload
                            photo</label>
                        <input
                            class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                            aria-describedby="review_photo" id="review_photo" type="file" name="review_photo">
                    </div>
                    <button type="submit"
