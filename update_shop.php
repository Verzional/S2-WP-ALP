...
<body>
    ...
    <!-- Form -->
    <section class="h-full bg-gray-900 sm:h-lvh">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            <h2 class="mb-4 text-xl font-bold text-white">Update Shop</h2>
            <form action="functions.php" method="POST" enctype="multipart/form-data">
                <div class="gap-4 sm:gap-6">
                    <div class="w-full mb-4">
                        <label for="shop" class="block mb-2 text-sm font-medium text-white">Shop</label>
                        <select id="shop" name="shop"
                            ...
                            <?php echo getShopName(); ?>
                        </select>
                    </div>
                    <div class="w-full mb-4">
                        <label for="name" class="block mb-2 text-sm font-medium text-white">New Shop
                            Name</label>
                        <input type="text" name="name" id="name"
                            ...
                            placeholder="Type shop name" required>
                    </div>
                    <div class="w-full mb-4">
                        ...
                        <select id="category" name="category"
                            ...
                            <option value="Cafe or Coffee Shop">Cafe or Coffee Shop</option>
                    ...
                    <div class="w-full mb-4">
                        ...
                        <textarea id="address" name="address" rows="8"
                            ...
                            placeholder="Shop address here" required></textarea>
                    </div>
                    <div class="w-full mb-4">
                        <label for="distance" class="block mb-2 text-sm font-medium text-white">Distance from
                            UC</label>
                        <input type="text" name="distance" id="distance" pattern="\d+(\.\d{1})?"
                            class="border text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500"
                            placeholder="0.1 km" required>
                    </div>

                    <div class="w-full mb-2">
                        <label class="block mb-2 text-sm font-medium text-white" for="shop_photo">Upload photo</label>
                        <input
                            ...
                            aria-describedby="shop_photo" id="shop_photo" type="file" name="shop_photo">
                    </div>
                    <button type="submit"
                        class="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-orange-500 rounded-lg focus:ring-4 focus:ring-primary-200 focus:ring-primary-900 hover:bg-primary-800"
                        name="update_shop">Update
                        Shop</button>
                </div>
            </form>
        </div>
        ...
        <div class="mx-auto max-w-screen-xl">
            <div class="md:flex md:justify-between">
                ...
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    ...
                    <div>
                        <h2 class="mb-6 text-sm font-semibold uppercase text-white">Universitas
                            Ciputra</h2>
                        <ul class="text-gray-400">
                            <li class="mb-4">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                ...
                <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    <a href="https://instagram.com/valentino.m.g/" class="text-gray-400 hover hover:text-white">
                    ...
                    <a href="https://github.com/Verzional" class="text-gray-400 hover hover:text-white">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path fill-rule="evenodd"
