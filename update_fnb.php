...
<body>
    ...
    <section class="h-full bg-gray-900 sm:h-lvh">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            <h2 class="mb-4 text-xl font-bold text-white">Update Food or Beverage</h2>
            <form action="functions.php" method="post" enctype="multipart/form-data">
                <div class="gap-4 sm:gap-6">
                    <div class="w-full mb-4">
                        <label for="fnb" class="block mb-2 text-sm font-medium text-white">Food and Beverage</label>
                        <select id="fnb" name="fnb"
                            ...
                            required>
                            <option value="" selected>Select FnB</option>
                            <?php echo getFnbName(); ?>
                        </select>
                    </div>
                    <div class="w-full mb-4">
                        <label for="shop" class="block mb-2 text-sm font-medium text-white">New Shop</label>
                    ...
                    <div class="w-full mb-4">
                        <label for="name" class="block mb-2 text-sm font-medium text-white">New Food or
                            Beverage
                            Name</label>
                        <input type="text" name="name" id="name"
                            class="border text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white"
                            placeholder="Type food or beverage name" required>
                    </div>
                    <div class="w-full mb-4">
                    ...
                    <div class="w-full mb-2">
                        <label class="block mb-2 text-sm font-medium text-white" for="fnb_photo">Upload
                            photo</label>
                        <input
                            ...
                            aria-describedby="fnb_photo" id="fnb_photo" type="file" name="fnb_photo">
                    </div>
                    <button type="submit"
                        ...
                        name="update_fnb">Update FnB</button>
                </div>
            </form>
        </div>
    </section>
