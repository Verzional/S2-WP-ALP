...
<body class="bg-gray-900">
    ...
    <section class="h-full bg-gray-900 sm:h-lvh">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Update Review</h2>
                ...
                <div class="gap-4 sm:gap-6">
                    ...
                    <div class="w-full mb-2">
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                            for="review_photo">Upload photo</label>
                        <input
                    ...
                    <button type="submit"
                        ...
                        name="update_review">Update Review</button>
                </div>
            </form>
        </div>
    </section>
