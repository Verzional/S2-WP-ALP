...
$newestShops = getShopDetails();
$newestFnB = getFnbDetails();
$newestReviews = getReviewDetails();
?>
...
<body class="bg-gray-900">
    ...
    <!-- Hero -->
    <section class="bg-gray-900 mt-4">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
            <h1 class="mb-4 text-4xl text-white font-extrabold tracking-tight leading-none md:text-5xl lg:text-6xl">
                Explore</h1>
            <p class="mb-2 text-base text-gray-400 font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48">Explore
                various shops, foods, and reviews from fellow UC Students</p>
        </div>
    </section>
    ...
    <section class="py-8 px-4 mx-auto max-w-screen-xl sm:py-12 lg:py-16 lg:px-12">
        <div class="flex items-center justify-between">
            <h2 class="mb-6 text-2xl font-semibold text-gray-900 dark:text-white">Newest Shops</h2>
            <a href="index.php"
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <?php foreach ($newestShops as $shops) { ?>
                <div class="bg-white rounded-lg shadow-lg dark:bg-gray-800">
                    <img src="<?php echo $shops['ShopImage']; ?>" class="object-cover w-full h-48 rounded-lg" alt="Shop" />
                    <div class="p-6">
                        <h3 class="mb-2 text-xl font-semibold text-white text-center"><?php echo $shops['ShopName']; ?>
                        </h3>
                        <p class="text-gray-400 text-center">Distance: <?php echo $shops['Distance']; ?> km</p>
                        <p class="text-gray-400 text-center">Category: <?php echo $shops['Category']; ?></p>
                    </div>
                </div>
            <?php } ?>
        </div>
    ...
    <section class="py-8 px-4 mx-auto max-w-screen-xl sm:py-12 lg:py-16 lg:px-12">
        <div class="flex items-center justify-between">
            <h2 class="mb-6 text-2xl font-semibold text-gray-900 dark:text-white">Newest FnB</h2>
            <a href="index.php"
                class="mb-4 text-gray-800 dark:text-orange-500 hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">
                See All</a>
        </div>
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <?php foreach ($newestFnB as $fnb) { ?>
                <div class="rounded-lg shadow-lg bg-gray-800">
                    <img src="<?php echo $fnb['FnbImage']; ?>" class="object-cover w-full h-48 rounded-t-lg" alt="FnB" />
                    <div class="p-6">
                        <h3 class="mb-2 text-xl font-semibold text-white text-center"><?php echo $fnb['FnbName']; ?>
                        </h3>
                        <p class="text-gray-400 text-center description mb-2"><?php echo $fnb['Description']; ?></p>
                        <p class="text-gray-400 text-center">Price: Rp
                            <?php echo number_format($fnb['Price'], 0, ',', '.'); ?>
                        </p>
                    </div>
                </div>
            <?php } ?>
    ...
    <section class="py-8 px-4 mx-auto max-w-screen-xl sm:py-12 lg:py-16 lg:px-12">
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <?php foreach ($newestReviews as $review) {
                ...
                <div class="rounded-lg shadow-lg bg-gray-800">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-400 text-center mb-2">By: <?php echo htmlspecialchars($username); ?></p>
