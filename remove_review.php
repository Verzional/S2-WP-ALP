...
<body class="bg-gray-900">
    ...
    <section class="h-lvh bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Remove Review</h2>
            <form action="functions.php" method="post" enctype="multipart/form-data">
                <div class="gap-4 sm:gap-6">
                    <div class="w-full mb-4">
                        <label for="review" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select
                            Review</label>
                        <select id="review" name="review"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            required>
                            <option value="" selected>Select Reviews</option>
                            <?php echo getReviewedTitles(); ?>
                        </select>
                    </div>
                    <div class="w-full mb-4">
                        <label for="reason" class="block mb-2 text-sm font-medium text-white">Reason</label>
                        <select id="reason" name="reason"
                            ...
                            <option value="Invalid Item">Invalid Item</option>
                            <option value="Others">Others</option>
                        </select>
                    </div>
                    <button type="submit"
                        class="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-2 text-sm font-medium text-center text-white bg-orange-500 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800"
                        name="remove_review">Remove Review
                    </button>
                </div>
            </form>
        </div>
