...
<body class="bg-gray-900">
    ...
    <section class="h-lvh bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Remove Shop</h2>
            <form action="functions.php" method="post" enctype="multipart/form-data">
                <div class="gap-4 sm:gap-6">
                    <div class="w-full mb-4">
                        <label for="shop" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select
                            Shop</label>
