...
<body>
    ...
    <!-- Message -->
    <div class="bg-gray-900 flex flex-col items-center justify-center h-screen">
        <div class="p-6 rounded-lg shadow-lg bg-gray-800 text-center">
            ...
            <h2 class="text-2xl font-semibold text-white mb-2">Success!</h2>
            <p class="text-gray-400 mb-6">Continue exploring UC Cravings</p>
            <a href="explore.php"
                class="mt-4 text-sm text-white bg-orange-500 hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded-lg px-4 py-2">Explore</a>
        </div>
    </div>
